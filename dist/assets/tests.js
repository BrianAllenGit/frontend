...
define('frontend/tests/components/update-product.jshint.lint-test', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | components/update-product.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/update-product.js should pass jshint.');
  });
});
...
define('frontend/tests/integration/components/update-product-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'wwJZck3B',
      'block': '{"statements":[["append",["unknown",["update-product"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
      'meta': {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'IgP/9ZDn',
      'block': '{"statements":[["text","\\n"],["block",["update-product"],null,null,0],["text","  "]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      template block text\\n"]],"locals":[]}],"hasPartials":false}',
      'meta': {}
    }));
...
define('frontend/tests/integration/components/update-product-test.jshint.lint-test', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | integration/components/update-product-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/update-product-test.js should pass jshint.');
  });
});
...
define('frontend/tests/routes/business/portal/store/index.jshint.lint-test', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | routes/business/portal/store/index.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/business/portal/store/index.js should pass jshint.');
  });
});
