...
define('frontend/components/intercom-io', ['exports', 'ember-intercom-io/components/intercom-io'], function (exports, _emberIntercomIoComponentsIntercomIo) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
      return _emberIntercomIoComponentsIntercomIo['default'];
    }
  });
});
...
define('frontend/initializers/ember-intercom', ['exports', 'ember-intercom-io/initializers/ember-intercom'], function (exports, _emberIntercomIoInitializersEmberIntercom) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('frontend/services/intercom', ['exports', 'ember-intercom-io/services/intercom', 'frontend/config/environment'], function (exports, _emberIntercomIoServicesIntercom, _frontendConfigEnvironment) {
  var _Ember = Ember;
  var getWithDefault = _Ember.getWithDefault;
  exports['default'] = _emberIntercomIoServicesIntercom['default'].extend({
    config: getWithDefault(_frontendConfigEnvironment['default'], 'intercom', {})
  });
});
...
if (!runningTests) {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+65eacd50"});
}
