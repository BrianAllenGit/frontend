...
define("frontend/components/infinite-table", ["exports", "ember"], function (exports, _ember) {
	exports["default"] = _ember["default"].Component.extend({
		didInsertElement: function didInsertElement() {
			var scrollMe = _ember["default"].$(".business-portal-contents");
			var that = this;
...
define("frontend/templates/components/infinite-table", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "VOxindwY", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"product-actions\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"link-to\"],[\"business.portal.store.products.add\",[\"get\",[\"storeId\"]]],null,3],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"table\",[]],[\"static-attr\",\"class\",\"items-table\"],[\"static-attr\",\"id\",\"scrollme\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"tr\",[]],[\"static-attr\",\"class\",\"items-table-header\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"th\",[]],[\"static-attr\",\"style\",\"text-align:left;\"],[\"flush-element\"],[\"text\",\"Name\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"th\",[]],[\"static-attr\",\"style\",\"text-align:right;\"],[\"flush-element\"],[\"text\",\"Price\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\\t\"],[\"append\",[\"helper\",[\"log\"],[[\"get\",[\"model\"]]],null],false],[\"text\",\"\\n\\n\"],[\"block\",[\"if\"],[[\"get\",[\"model\"]]],null,2],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"block\",[\"unless\"],[[\"get\",[\"model\"]]],null,0]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\t\\t\\t\\t\"],[\"append\",[\"unknown\",[\"loading-animation\"]],false],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\\t\"],[\"open-element\",\"tr\",[]],[\"flush-element\"],[\"text\",\"\\n\\t\\t    \"],[\"open-element\",\"td\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"product\",\"name\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\\t    \"],[\"open-element\",\"td\",[]],[\"flush-element\"],[\"text\",\"$\"],[\"append\",[\"unknown\",[\"product\",\"price\"]],false],[\"close-element\"],[\"text\",\"\\n\\t  \\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"product\"]},{\"statements\":[[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,1]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"portal-button\"],[\"flush-element\"],[\"text\",\"\\n\\t\\tAdd Product\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "frontend/templates/components/infinite-table.hbs" } });
});
...
define("frontend/templates/components/receipt-details", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "wIlDQC11", "block": "{\"statements\":[[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "frontend/templates/components/receipt-details.hbs" } });
});
...
if (!runningTests) {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+4ce2ab9e"});
}
